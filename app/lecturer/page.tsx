            ...
            <main className={`${isDesktopSidebarOpen ? 'lg:ml-64' : 'lg:ml-16'} min-h-screen pb-8 transition-all duration-300`}>
                <header className="sticky top-0 z-20 bg-white/95 dark:bg-[#1a1a0b]/95 backdrop-blur-md border-b border-gray-200 dark:border-[#33331a] px-4 lg:px-8 py-4 lg:py-6">
                    <div className="max-w-7xl mx-auto flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl lg:text-4xl font-bold text-[#181811] dark:text-white">Lecturer Dashboard</h1>
                                <p className="hidden lg:block text-gray-600 dark:text-gray-400 mt-1">Manage your classes and students</p>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-4 lg:px-8 py-6 lg:py-8">
                    <div className="flex items-center justify-between mb-6 lg:mb-8">
                        <h2 className="text-xl lg:text-2xl font-bold text-[#181811] dark:text-white">Your Students</h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {students.map((s) => (
                                <article key={s.id} className="bg-white dark:bg-[#23220f] border-2 border-gray-200 dark:border-[#33331a] rounded-xl p-5 shadow-sm">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 rounded-full bg-gray-200 dark:bg-[#33331a] flex items-center justify-center text-xl font-bold">{s.name.split(' ').map(n=>n[0]).slice(0,2).join('')}</div>
                                        <div>
                                    ...
                                    <div className="mt-4 flex items-center gap-2">
                                        ...
                                        <button className="w-10 h-10 rounded-full border-2 border-gray-200 dark:border-[#33331a] flex items-center justify-center">
