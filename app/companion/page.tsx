                ...
                <main className={`${isDesktopSidebarOpen ? 'lg:ml-64' : 'lg:ml-16'} min-h-screen pb-8 transition-all duration-300`}>
                    ...
                    <div className="max-w-7xl mx-auto px-4 lg:px-8 py-6 lg:py-8">
                        <div className="flex items-center justify-between mb-6 lg:mb-8">
                            <h2 className="text-xl lg:text-2xl font-bold text-[#181811]">Linked Students</h2>
                            <button className="text-sm lg:text-base font-semibold text-[#8c8b5f] hover:text-[#181811] transition-colors">Manage links</button>
                        </div>
                                ...
                                <article key={s.id} className="bg-white border-2 border-gray-200 rounded-xl p-5 shadow-sm">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">{s.relation} • {s.grade}</p>
                                        </div>
                        ...
                        <div className="mt-8">
                            <h3 className="text-lg font-bold text-[#181811] mb-3">Support & Donations</h3>
                            <div className="p-4 border rounded-lg bg-white">Quick links to support learning and donate</div>
                        </div>
                    </div>
                </main>
            </div>
